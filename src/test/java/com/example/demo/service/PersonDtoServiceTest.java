...
class PersonDtoServiceTest {
    ...
    void getPeople() {
        ...
        when(personMapper.entityToDtoMapper(Optional.ofNullable(persons.get(0)))).thenReturn(personDto);
    ...
    void getPersonByIdWhenFound() {
        ...
        when(personMapper.entityToDtoMapper(Optional.of(person))).thenReturn(personDto);
